<template>
    <main class="home-record-transaction">
        <div class="category">
            <CategoryDropDownButton :title="selectedMainCategory.name" drop-size="small" :img-file-name="selectedMainCategory.imgFileName" :options="mainCategories.filter(v => v.id !== selectedMainCategory.id)" @valueSelected="updateMainSelectedCategory"/>
            <CategoryDropDownButton :title="selectedCategory.name" :drop-size="selectedMainCategory.id === 'income' ? 'small' : 'large'" :img-file-name="selectedCategory.imgFileName" :options="filteredCategories.filter(v => v.id !== selectedCategory.id)" @valueSelected="updateSelectedCategory"/>
        </div>
